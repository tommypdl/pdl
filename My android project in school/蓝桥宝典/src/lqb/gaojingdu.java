...
public class gaojingdu extends Activity {
		String sousuo[]={"斐波那契","Java大数","麦森数"};
		LinearLayout ll;
		ListView lv;
		@Override
		protected void onCreate(Bundle savedInstanceState) {
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
						int arg2, long arg3) {
					// TODO Auto-generated method stub
					Toast.makeText(gaojingdu.this, arg2+"", Toast.LENGTH_LONG).show();
					Intent i=new Intent();
					
						i.putExtra("pos", arg2+"");
						i.setClass(gaojingdu.this, gaojingdudeal.class);
						startActivity(i);
