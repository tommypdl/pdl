...
public class diguideal extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		switch (p) {
		case 0:
			text=getText(diguideal.this,"fibonacci.txt");
			break;
		case 1:
			text=getText(diguideal.this,"gcd.txt");
			break;
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case TEST_ID:
			...
			if(p==0||p==1){
				...
				String pos=p+"";
				i.putExtra("pos", pos);
				i.setClass(diguideal.this, diguishowtest.class);
				startActivity(i);
			}
			else{
				Toast.makeText(diguideal.this, "本题暂不支持测试", Toast.LENGTH_LONG).show();
			}
			return true;
