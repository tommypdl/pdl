...
public class tanxindeal extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		switch (p) {
		case 0:
			text=getText(tanxindeal.this,"banzhuozi.txt");
			break;
		case 1:
			text=getText(tanxindeal.this,"fancoin.txt");
			break;
		case 2:
			text=getText(tanxindeal.this,"zhipai.txt");
			break;
		default:
			break;
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case TEST_ID:
				...
				Toast.makeText(tanxindeal.this, "本题暂不支持测试", Toast.LENGTH_LONG).show();
