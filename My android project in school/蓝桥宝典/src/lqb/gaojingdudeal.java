...
public class gaojingdudeal extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		switch (p) {
		case 0:
			text=getText(gaojingdudeal.this,"bigfibonacci.txt");
			break;
		case 1:
			text=getText(gaojingdudeal.this,"javadashu.txt");
			break;
		case 2:
			text=getText(gaojingdudeal.this,"maisenshu.txt");
			break;
		default:
			break;
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		case TEST_ID:
				...
				Toast.makeText(gaojingdudeal.this, "本题暂不支持测试", Toast.LENGTH_LONG).show();
