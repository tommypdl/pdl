...
public class DiaryDbAdapter {
	...
	private static String DATABASE_CREATE = "create table diary(_id integer primary key autoincrement,"
	...
	public long createDiary(String title,String body){
		...
		String created=calendar.get(Calendar.YEAR)+"年"+(calendar.get(Calendar.MONTH)+1)+"月"+calendar.get(Calendar.DAY_OF_MONTH)+"日"+calendar.get(Calendar.HOUR_OF_DAY)+"时"+calendar.get(Calendar.MINUTE)+"分";
	...
	public Cursor getAllNotes(){
		System.out.println(mDb.getPath());
	...
	public boolean updateDiary(long rowId,String title,String body){
		...
		Calendar calendar=Calendar.getInstance();
		String created=calendar.get(Calendar.YEAR)+"年"+calendar.get(Calendar.MONTH)+"月"+calendar.get(Calendar.DAY_OF_MONTH)+"日"+calendar.get(Calendar.HOUR_OF_DAY)+"时"+calendar.get(Calendar.MINUTE)+"分";
